...
m_games = Menu("Игры", buttons=["Камень, ножницы, бумага, ящерица, Спок", "Выход"], parent=m_main)
...
m_fun = Menu("Развлечения", buttons=["Прислать собаку", "Прислать анекдот", "Создать пароль", "Прислать игру", "Выход"], parent=m_main)
