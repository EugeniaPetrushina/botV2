...
m_v = Menu("Виселица", buttons=["Загадать слово", "Буква", "Выход"], parent=m_games)

m_RSPLS = Menu("Камень, ножницы, бумага, ящерица, Спок", buttons=["Камень", "Ножницы", "Бумага", "Ящерица", "Спок", "Правила КНБЯС", "Выход"], parent=m_games)

m_DZ = Menu("ДЗ", buttons=["Задание-1", "Задание-2", "Задание-3", "Задание-4", "Задание-5", "Задание-6", "Выход"], parent=m_main)

m_fun = Menu("Развлечения", buttons=["Прислать собаку","Прислать кошку", "Прислать анекдот", "Создать пароль", "Прислать игру", "Выход"], parent=m_main)
